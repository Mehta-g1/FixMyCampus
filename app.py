...
@st.dialog("Message")
def ban_message():
    st.warning("⚠️ Oops! It looks like you've been banned. Please reach out to the admin if you think this is a mistake.")
...
def login():
    ...
    with st.form("login_form"):
        ...
        Admin_button = col6.link_button("Admin login","https://fixmycampusdmin.streamlit.app/")
